// Multi-language support for AgentSDR Platform
...
const TRANSLATIONS = {
    'en': {
        // Header
        'header.title': 'AgentSDR – AI-Powered Sales Development Platform',
        ...
        'footer.legal': 'Legal',
        'footer.copyright': '© 2024 AgentSDR. All rights reserved.',
        
        // Notifications
        'notification.language_changed': 'Language changed to',
        'notification.welcome': 'Welcome to AgentSDR Enterprise AI Platform!',
...
let currentLanguage = localStorage.getItem('agentsdrLanguage') || 'en';
...
class LanguageManager {
    ...
    changeLanguage(langCode) {
        if (this.supportedLanguages[langCode]) {
            ...
            localStorage.setItem('agentsdrLanguage', langCode);
