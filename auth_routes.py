"""
Authentication Routes for AgentSDR Platform
...
def login():
    ...
    try:
        ...
        if user_data['role'] == 'super_admin':
            ...
            redirect_url = '/dashboard.html'  # Regular users use standard dashboard
...
def list_users():
    ...
    # Admins can only see users in their organization, super_admins see all
...
<html>
<head>
    <title>AgentSDR - User Management</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <style>
        body { font-family: Arial, sans-serif; margin: 0; padding: 20px; background: #f5f5f5; }
