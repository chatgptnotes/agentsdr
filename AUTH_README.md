# AgentSDR Authentication System

## Overview
Simple role and status-based authentication system for AgentSDR platform using JWT tokens and SQLite database.
...
curl -X POST http://localhost:3000/api/auth/login \
  ...
  -d '{"email":"admin@agentsdr.com","password":"admin123"}'
```
