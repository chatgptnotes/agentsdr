...
Handles trial limitations and access controls for AgentSDR platform
"""
        ...
        def decorated_function(*args, **kwargs):
            ...
            try:
                ...
                if trial_status.get('expired', False):
                    return jsonify({
                        'error': 'Trial expired',
                        'message': 'Your 14-day free trial has expired. Please upgrade to continue using AgentSDR.',
